...
function ArrowLink({ href, children }: { href: string; children: React.ReactNode }) {
  return (
    <Link href={href} className="group inline-flex items-center gap-2 text-[15px] font-semibold text-brand">
      {children}
          ...
          {projects.map((p) => (
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col justify-end bg-gradient-to-t from-[#1a183a]/85 via-transparent to-transparent p-5">
                ...
                <p className="mr-12 mt-1 text-[13px] leading-relaxed text-white/80">{p.desc}</p>
              </div>
