    ...
    <>
      <header className="px-6 pb-3 pt-14 sm:px-[52px]">
        ...
        <p className="mt-4 max-w-[560px] text-[17px] leading-relaxed text-body">
          ...
          <span className="font-semibold text-brand">Survole un logo</span> pour voir le détail.
        </p>
      </header>
      ...
      <section className="px-6 pb-16 sm:px-[52px]">
        <p className="mb-2.5 font-mono text-xs tracking-[1.5px] text-muted-ink">MÉTHODES</p>
        <p className="text-[15px] leading-relaxed text-body">
          Agile — Scrum &amp; Kanban · Tests &amp; intégration continue · Documentation technique
        </p>
      </section>
    </>
  );
